...
import { Lock, User as UserIcon, Mail, Eye, EyeOff, Sun, Moon } from 'lucide-react';
...
const SignupPage = () => {
    ...
    // Password strength — soft color scale
    const getPasswordStrength = () => {
        if (password.length === 0) return null;
        if (password.length < 6) return { label: 'Too short', level: 1, color: 'var(--warning)' };
        if (password.length < 8) return { label: 'Weak', level: 2, color: 'var(--warning)' };
        if (/[A-Z]/.test(password) && /[0-9]/.test(password) && /[^A-Za-z0-9]/.test(password)) {
            return { label: 'Strong', level: 4, color: 'var(--success)' };
        }
        return { label: 'Medium', level: 3, color: 'var(--accent)' };
    };
                            ...
                            <div>
                                <div className="relative">
                                    ...
                                    <button
                                        ...
                                        style={{ color: 'rgb(var(--ios-label-tertiary))', background: 'none', border: 'none', cursor: 'pointer' }}
                                ...
                                {/* Password Strength Meter — soft, floating */}
                                {passwordStrength && (
                                    <div className="mt-2.5 px-1">
                                        ...
                                        <p
                                            className="mt-1.5"
                                            style={{ fontSize: '12px', fontWeight: 500, color: passwordStrength.color }}
                                        >
